...
?>
				<div id="content" class="single" style="width:860px; margin:0 20px;">
					<div id="box5" class="box-style">
                        ...
                        <div class="clearfix">
                            <div class="clearfix">
                                <h2 class="title" style="float:left;margin:0 0 15px 0;"><?php echo $r['name']; ?>(<?php echo $r['name_en']; ?>)目錄</h2>
                                <a style="float:left;margin:14px 0 0 40px;" href="<?php echo url('/'.$r['name'].'.html'); ?>">關於 <?php echo $r['name']; ?>(<?php echo $r['name_en']; ?>) ...</a>
                            </div>
<?php
    $max=$r['max_chapter'];
    $blockChaps=20;
