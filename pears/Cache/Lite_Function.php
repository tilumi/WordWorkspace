        ...
        if ($data !== false) {
            ...
            if (is_array($target)) {
                ...
                switch( count($arguments) ){
                    case 0: $result = &$object->$method(); break;
                    case 1: $result = &$object->$method( $arguments[0] ); break;
                    case 2: $result = &$object->$method( $arguments[0],$arguments[1] ); break;
                    case 3: $result = &$object->$method( $arguments[0],$arguments[1],$arguments[2] ); break;
                    case 4: $result = &$object->$method( $arguments[0],$arguments[1],$arguments[2],$arguments[3] ); break;
                    case 5: $result = &$object->$method( $arguments[0],$arguments[1],$arguments[2],$arguments[3],$arguments[4] ); break;
                    default: $result = call_user_func_array( array( &$object, $method ) , $arguments );
                }
